...
class Runner:
    def run(data01):
        ...
        twohavles = [x for x in data01 if x >= Q2] and [x for x in data01 if x < Q2]
        ...
        data02 = [round(x - original_mean, 3) for x in data01]   
        data03 = [round(-x, 3) for x in data02]                  
        data04 = [round((x - original_mean) * 0.75 + 100, 3) for x in data01] 
