...
"""
This program displays a single plot with two functions, a damped cosine and normal cosine.
The plot features an adaptive grid with major and minor lines in different colors and styles, 
...
class Runner:
    def run():
        ...
        # Setup plot
        fig, ax0 = plt.subplots(1, 1, facecolor='1.0', linewidth=3)
        ...
        ax0.tick_params(axis='both', which='major', labelcolor='green', colors='black', width=2, length=10)
        ax0.tick_params(axis='both', which='minor', labelcolor='green', colors='black', width=1)
